...
import com.example.demodbbootclient.controller.NewRegisterController;
...
public class App extends Application {
    ...
    public static boolean showRegisterAddDialog(Register register, Integer id){
        try {
            FXMLLoader fxmlLoader = new FXMLLoader();
            fxmlLoader.setLocation(RegisterOverviewController.class.getResource("/view/NewRegister.fxml"));
            AnchorPane page = (AnchorPane) fxmlLoader.load();
            ...
            NewRegisterController controller = fxmlLoader.getController();
            controller.setDialogStage(dialogStage);
            controller.setLabels(register, id);
